...
CREATE TABLE year2022_income_age_22_29(
	year2022_income_age_22_29_id INT PRIMARY KEY AUTO_INCREMENT
	)
	SELECT 
		substr(description, 1, LENGTH(description)-11) AS regional_name, 
		`number_of_jobs_(thousand)`,
...
SELECT * 
FROM year2022_income_age_22_29;
...
OR median_weekly_gross_pay LIKE '%,%'
OR mean_weekly_gross_pay LIKE '%,%'
OR percentiles_10 LIKE '%,%'
OR percentiles_20 LIKE '%,%'
OR percentiles_25 LIKE '%,%'
OR percentiles_30 LIKE '%,%'
OR percentiles_40 LIKE '%,%'
...
-- Change made: from 1,054.1 to 1054.1 removing ','.
UPDATE year2022_income_age_22_29
SET percentiles_90 = '1054.1'
WHERE percentiles_90 = '1,054.1';

-- Step 6: Change data types from string data type to INT for number of jobs and 'DECIMAL(10,2)' for other numerical columns.
ALTER TABLE year2022_income_age_22_29
...
-- Step 7: Join year2022_income_age_22_29 and regional_code table.
SELECT 
	rc.code AS regional_code,
	yr2022.regional_name,
	yr2022.`number_of_jobs_(thousand)` ,
	yr2022.median_weekly_gross_pay,
	yr2022.median_annual_percentage_change,
	yr2022.mean_weekly_gross_pay,
	yr2022.mean_annual_percentage_change,
	yr2022.percentiles_10,
	yr2022.percentiles_20,
	yr2022.percentiles_25,
	yr2022.percentiles_30,
	yr2022.percentiles_40,
	yr2022.percentiles_60,
	yr2022.percentiles_70,
	yr2022.percentiles_75,
	yr2022.percentiles_80,
	yr2022.percentiles_90
FROM year2022_income_age_22_29 yr2022
JOIN regional_code rc
ON yr2022.regional_name = rc.regional_name;
