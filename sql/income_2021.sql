...
CREATE TABLE year2021_income_age_22_29(
	year2021_income_age_22_29_id INT PRIMARY KEY AUTO_INCREMENT
	)
	SELECT 
		substr(description, 1, LENGTH(description)-11) AS regional_name, 
		`number_of_jobs_(thousand)`,
...
SELECT * 
FROM year2021_income_age_22_29;
...
-- Change made: from 1,038.6 to 1038.6 removing ','.
UPDATE year2021_income_age_22_29
SET percentiles_90 = '1038.6'
WHERE percentiles_90 = '1,038.6';

-- Step 6: Change data types from string data type to INT for number of jobs and 'DECIMAL(10,2)' for other numerical columns.
ALTER TABLE year2021_income_age_22_29
...
-- Step 7: Join year2021_income_age_22_29 and regional_code table.
SELECT 
	rc.code AS regional_code,
	yr2021.regional_name,
	yr2021.`number_of_jobs_(thousand)` ,
	yr2021.median_weekly_gross_pay,
	yr2021.median_annual_percentage_change,
	yr2021.mean_weekly_gross_pay,
	yr2021.mean_annual_percentage_change,
	yr2021.percentiles_10,
	yr2021.percentiles_20,
	yr2021.percentiles_25,
	yr2021.percentiles_30,
	yr2021.percentiles_40,
	yr2021.percentiles_60,
	yr2021.percentiles_70,
	yr2021.percentiles_75,
	yr2021.percentiles_80,
	yr2021.percentiles_90
FROM year2021_income_age_22_29 yr2021
JOIN regional_code rc
ON yr2021.regional_name = rc.regional_name;
