...
CREATE TABLE year2020_income_age_22_29(
	year2020_income_age_22_29_id INT PRIMARY KEY AUTO_INCREMENT
	)
	SELECT 
		substr(description, 1, LENGTH(description)-11) AS regional_name, 
		`number_of_jobs_(thousand)`,
...
SELECT * 
FROM year2020_income_age_22_29;
...
-- Change made: from 1,015.7 to 1015.70 removing ','.
UPDATE year2020_income_age_22_29
SET percentiles_90 = '1015.7'
WHERE percentiles_90 = '1,015.7';

-- Step 6: Change data types from string data type to INT for number of jobs and 'DECIMAL(10,2)' for other numerical columns.
ALTER TABLE year2020_income_age_22_29
...
SELECT 
	...
	yr2020.regional_name,
	yr2020.`number_of_jobs_(thousand)` ,
	yr2020.median_weekly_gross_pay,
	yr2020.median_annual_percentage_change,
	yr2020.mean_weekly_gross_pay,
	yr2020.mean_annual_percentage_change,
	yr2020.percentiles_10,
	yr2020.percentiles_20,
	yr2020.percentiles_25,
	yr2020.percentiles_30,
	yr2020.percentiles_40,
	yr2020.percentiles_60,
	yr2020.percentiles_70,
	yr2020.percentiles_75,
	yr2020.percentiles_80,
	yr2020.percentiles_90
FROM year2020_income_age_22_29 yr2020
JOIN regional_code rc
ON yr2020.regional_name = rc.regional_name;
